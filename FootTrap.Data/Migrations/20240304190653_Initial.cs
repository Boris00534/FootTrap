        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShoeUrlImage = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "599457c1-5737-4071-acbe-9f2cc064e41d", "0eef1000-e7a0-4a14-9f7a-4c7e7ad324d3" });

            migrationBuilder.InsertData(
                table: "AspNetUserRoles",
                columns: new[] { "RoleId", "UserId" },
                values: new object[] { "2d5a35b7-23c2-4d95-b772-4b91609e65e7", "ff2007b9-1919-4382-983f-a583d47b9040" });

            migrationBuilder.InsertData(
                table: "Customers",
                columns: new[] { "Id", "IsActive", "UserId" },
                values: new object[] { "a3bd28c7-f6f8-4eb8-9ca3-d3539faf427e", true, "ff2007b9-1919-4382-983f-a583d47b9040" });
